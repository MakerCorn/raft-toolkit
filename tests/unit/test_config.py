...
class TestRaftConfig:
    ...
    def test_config_creation(self):
        ...
        config = RaftConfig(datapath=Path("test.pdf"), output="output_dir", openai_key="test-key")
...
"""
    ...
    def test_get_config_without_env_file(self, temp_directory):
        ...
        env_vars = {"RAFT_DATAPATH": str(test_file), "RAFT_OUTPUT": "default_output", "OPENAI_API_KEY": "default-key"}
