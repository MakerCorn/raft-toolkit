...
class EmbeddingService:
    ...
    def _load_embedding_template(self) -> str:
        ...
        try:
            template = self.template_loader.load_embedding_template(
    ...
    def create_embeddings_with_template(self, chunks: List[DocumentChunk]) -> List[DocumentChunk]:
        ...
        try:
            ...
            self.langwatch_service.track_embedding_generation(
                chunks, processing_time, self.config.embedding_model
            )
    ...
    def _format_text_for_embedding(self, content: str, document_type: str = "unknown", 
                                  metadata: Optional[Dict[str, Any]] = None, 
                                  chunk_index: Optional[int] = None,
                                  chunking_strategy: Optional[str] = None) -> str:
        """
    ...
    def get_embedding_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "template_preview": self.embedding_template[:200] + "..." if len(self.embedding_template) > 200 else self.embedding_template
        }
