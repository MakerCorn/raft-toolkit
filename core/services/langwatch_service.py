...
from ..models import DocumentChunk, Question, QADataPoint
...
class LangWatchService:
    ...
    @contextmanager
    def span_operation(self, name: str, span_type: str = "workflow", 
    ...
    def track_document_processing(self, chunks: List[DocumentChunk], 
    ...
    def track_question_generation(self, chunk: DocumentChunk, 
    ...
    def track_answer_generation(self, question: str, context: str, 
                              answer: str, processing_time: float,
                              model_name: str):
        """
    ...
    def track_qa_dataset_generation(self, qa_data_points: List[QADataPoint],
        ...
        with self.trace_operation("qa_dataset_generation", operation_metadata) as trace:
            if trace:
                with self.span_operation(
                    ...
                    "workflow",
                    input_data={
                        "qa_pairs_requested": len(qa_data_points)
                    },
                    metadata=operation_metadata
                ) as span:
                    if span:
    ...
    def track_embedding_generation(self, chunks: List[DocumentChunk],
                                 processing_time: float,
                                 model_name: str):
        """
        ...
        with self.span_operation(
            ...
            if span:
                span.output = {
                    ...
                    "success": True,
                    "avg_embedding_dimension": len(chunks[0].embedding) if chunks and hasattr(chunks[0], 'embedding') and chunks[0].embedding else None
                }
