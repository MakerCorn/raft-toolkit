...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--completion_model", type=str, default="gpt-35-turbo", help="The model to use to generate questions and answers (gpt-3.5, gpt-4, ...)")
    ...
    parser.add_argument("--use-azure-identity", type=bool, default=True, help="Use MS Entra ID for token retrieval")
